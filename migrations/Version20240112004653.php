 ...
 */
final class Version20240112004653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE playlist (id INT NOT NULL, user_email VARCHAR(255) DEFAULT NULL, titre VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D782112D550872C ON playlist (user_email)');
        ...
        $this->addSql('CREATE TABLE "user" (email VARCHAR(255) NOT NULL, artiste_id INT DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, pseudo VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, tel VARCHAR(255) DEFAULT NULL, is_verified BOOLEAN NOT NULL, PRIMARY KEY(email))');
        ...
        $this->addSql('ALTER TABLE playlist ADD CONSTRAINT FK_D782112D550872C FOREIGN KEY (user_email) REFERENCES "user" (email) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE playlist DROP CONSTRAINT FK_D782112D550872C');
