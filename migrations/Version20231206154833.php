 ...
 */
final class Version20231206154833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE musique (id INT NOT NULL, titre VARCHAR(255) NOT NULL, duree INT NOT NULL, date_sortie DATE NOT NULL, parole TEXT DEFAULT NULL, PRIMARY KEY(id))');
